      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6 lg:pr-8">
            <h2 className="text-3xl font-black tracking-[0.2em] uppercase text-white">
              Aroyana
            </h2>
            <p className="text-sm leading-relaxed text-neutral-400">
              Redefining modern luxury. Crafted with uncompromising precision, designed for the visionary. Step into the world of elegance.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-5 text-sm text-neutral-400">
              ...
              <li><Link href="/about" className="hover:text-white transition-colors duration-300">Our Heritage</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-5 text-sm text-neutral-400">
              ...
              <li><Link href="/contact" className="hover:text-white transition-colors duration-300">FAQ</Link></li>
            </ul>
          </div>

          {/* ৪. Connect & Socials */}
          <div>
            <h3 className="text-xs font-bold uppercase tracking-[0.15em] text-white mb-6">Connect</h3>
            <p className="text-sm text-neutral-400 mb-6 leading-relaxed">
              Join our exclusive circle for early access to new drops and private events.
            </p>
        ...
        {/* ৫. Copyright & Legal */}
        <div className="border-t border-neutral-900 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-neutral-600 gap-4">
          <p className="tracking-wide">&copy; {new Date().getFullYear()} AROYANA EXCLUSIVES. ALL RIGHTS RESERVED.</p>
          <div className="flex gap-6 uppercase tracking-wider">
            <Link href="/about" className="hover:text-white transition-colors duration-300">Privacy Policy</Link>
            <Link href="/about" className="hover:text-white transition-colors duration-300">Terms of Service</Link>
          </div>
        </div>
